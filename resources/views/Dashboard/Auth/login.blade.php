                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1" style="direction: rtl">
                                    {{ ('Welcome To Task Manager') }}! 👋</h2>
                                <p class="card-text mb-2" style="direction: rtl">
                                    {{ ('Please sign-in to your account and start') }}</p>
                                <form class="auth-login-form mt-2" action="{{ route('dashboard.authenticate') }}"
                                    method="POST">
                                    @csrf
                                    <div class="mb-1">
                                    ...
                                    <button class="btn w-100" style="background: #7ABEB9;color:white"
